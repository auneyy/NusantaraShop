                            ...
                            <div id="sizes-container">
                                ...
                                @if($product->sizes->count() > 0)
                                    ...
                                    <div class="size-input-group row mb-2">
                                        <div class="col-md-4">
                                            <input type="text" class="form-control size-name" name="sizes[{{ $sizeCounter }}][size]" 
                                                   value="{{ old('sizes.'.$sizeCounter.'.size', $size->size) }}" placeholder="Size (contoh: S, M, L)" required>
                                        </div>
                                        <div class="col-md-4">
                                            <input type="number" class="form-control size-stock" name="sizes[{{ $sizeCounter }}][stock]" 
                                                   value="{{ old('sizes.'.$sizeCounter.'.stock', $size->stock) }}" placeholder="Stok" min="0" required>
                                        </div>
                                        <div class="col-md-4">
...
@push('scripts')
<script>
    let sizeCounter = {{ $product->sizes->count() > 0 ? $product->sizes->count() : 1 }};
