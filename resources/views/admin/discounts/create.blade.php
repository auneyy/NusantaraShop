...
<div class="container-fluid">
    <div class="d-flex justify-content-between mb-4">
        <h1 class="h3">Tambah Diskon Baru</h1>
            ...
            <form action="{{ route('admin.discounts.store') }}" method="POST">
                ...
                <div class="row">
                    <div class="col-md-6">
                        ...
                        <div class="form-group" id="percentage-field" style="display: {{ old('type') == 'percentage' ? 'block' : 'none' }};">
                        ...
                        <div class="form-group" id="fixed-amount-field" style="display: {{ old('type') == 'fixed' ? 'block' : 'none' }};">
                            <label for="fixed_amount">Nominal Diskon (Rp) *</label>
                            <input type="number" class="form-control @error('fixed_amount') is-invalid @enderror" id="fixed_amount" name="fixed_amount" value="{{ old('fixed_amount') }}" min="0">
                            @error('fixed_amount')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="form-group">
                            ...
                            <input type="color" class="form-control @error('banner_color') is-invalid @enderror" id="banner_color" name="banner_color" value="{{ old('banner_color', '#FF5733') }}" required>
                            @error('banner_color')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                        ...
                        <div class="form-group">
                            ...
                            <input type="color" class="form-control @error('text_color') is-invalid @enderror" id="text_color" name="text_color" value="{{ old('text_color', '#FFFFFF') }}" required>
                            @error('text_color')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
